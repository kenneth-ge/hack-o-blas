...
def matmul_kernel(
    ...
    #a_ptr = tl.int_to_ptr(a_int)
    #b_ptr = tl.int_to_ptr(b_int)
    #c_ptr = tl.int_to_ptr(c_int)

    #a_ptr = tl.pointer_type(a_ptr)
    #b_ptr = tl.pointer_type(b_ptr)
    #c_ptr = tl.pointer_type(c_ptr)
